...
import { bigint, boolean, index, pgTable, primaryKey, text, timestamp, uniqueIndex, varchar, } from "drizzle-orm/pg-core";
export const identifiers = pgTable("identifiers", {
    ...
    return {
        IDX_6098cca69c838d91e55ef32fe1: uniqueIndex("IDX_6098cca69c838d91e55ef32fe1").on(table.provider, table.alias),
    };
});
...
export const keyvaluestore = pgTable("keyvaluestore", {
    key: varchar("key").primaryKey().notNull(),
    data: text("data").notNull(),
}, (table) => {
    return {
        IDX_f4824d8a354cbf404f1cbebe02: uniqueIndex("IDX_f4824d8a354cbf404f1cbebe02").on(table.key),
    };
});
export const credentialsToMessages = pgTable("credentials_to_messages", {
    ...
    return {
        indexIdHash: index("IDX_indexIdHash").on(table.messageId, table.credentialHash),
...
export const presentationsToVerifierIdentifiers = pgTable("presentation_to_verifier_identifier", {
    ...
    return {
        IDX_c3b760612b992bc75511d74f6a: index("IDX_c3b760612b992bc75511d74f6a").on(table.presentationHash, table.identifierDid),
...
export const presentationsToCredentials = pgTable("presentations_to_credentials", {
    presentationHash: varchar("presentationHash")
        .notNull()
        .references(() => presentations.hash, { onDelete: "cascade" }),
    credentialHash: varchar("credentialHash")
    ...
    return {
        IDX_32d9cee791ee1139f29fd94b5c: index("IDX_32d9cee791ee1139f29fd94b5c").on(table.presentationHash, table.credentialHash),
...
export const messagesToPresentations = pgTable("messages_to_presentations", {
    ...
    return {
        IDX_9dc4cc025ec7163ec5ca919d14: index("IDX_9dc4cc025ec7163ec5ca919d14").on(table.messageId, table.presentationHash),
